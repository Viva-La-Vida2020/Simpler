...
from models.train_and_evaluate import Solver, train_double, evaluate_double, Subspace
    ...
    for e in range(epochs):
        ...
        if e >= 60:
            ...
            if float(value_ac) / eval_total > best_val_acc:
                ...
                best_epoch = e
                solver.save_pretrained(os.path.join(args.save, 'models_best'))
                tokenizer.save_pretrained(os.path.join(args.save, 'models_best'))
...
def get_parser():
    ...
    parser.add_argument('--save', default='./experiments/test1', type=str)
    parser.add_argument('--device', default=0, type=int)
    parser.add_argument('--batch_size', default=16, type=int)
    parser.add_argument('--seed', default=3407, type=int)
    parser.add_argument('--lr', default=5e-5, type=float)
    parser.add_argument('--dataset', default='Math23k', type=str)
