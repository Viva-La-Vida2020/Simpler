...
def train_simpler_cl(args):
    ...
    if args.dataset in ['Math23k']:
        ...
        pretrain_model_path = "pretrain_model/chinese-bert-wwm-ext"
        config = AutoConfig.from_pretrained(pretrain_model_path)
        # tokenizer = BertTokenizer.from_pretrained("hfl/chinese-bert-wwm-ext")
        tokenizer = BertTokenizer.from_pretrained("pretrain_model/chinese-bert-wwm-ext")
        epochs = 120
...
def get_parser():
    ...
    parser.add_argument('--CL', default='SimCLR', type=str, choices=['SimplerCL', 'SimCLR', 'NoCL'])
